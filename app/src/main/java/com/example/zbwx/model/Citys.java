...
public class Citys {
    private String[] province = {"请选则城市", "北京市", "上海市", "天津市", "重庆市", "河北省", "山西省", "辽宁省", "吉林省", "河南省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "湖北省", "湖南省", "广东省", "海南省", "四川省", "贵州省", "云南省", "陕西省", "甘肃省", "青海省", "黑龙江省", "内蒙古自治区", "广西壮族自治区", "西藏自治区", "宁夏回族自治区", "新疆维吾尔自治区", "台湾省", "香港特别行政区", "澳门特别行政区", "其它"};
...
//其它地区
    ...
    public String[] getProvince(){
        String[] strings=province;
        return strings;
    }
    public String getProvince(int positon){
        String strings=province[positon];
        return strings;
    }
    ...
    public String[] getCityData(int positon){
        String[] cd = cityData[positon];
        return cd;
    }
}
